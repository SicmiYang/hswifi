package com.nfyg.hswx.data;

import com.nfyg.hswx.model.entity.NewsEntity;
import com.nfyg.hswx.model.entity.CityEntity;
...
public class Constants {
	...
	public static ArrayList<NewsEntity> getNewsList() {
		...
		for(int i =0 ; i < 10 ; i++){
			...
			news.setTypeCode(ITEM_TYPE_ONLY_TEXT);
			news.setId(i);
			news.setNewsId(i);
			...
			if(i%2 == 1){
				news.setTypeCode(ITEM_TYPE_MULTI_IMAGE);
				...
				news.setTypeCode(ITEM_TYPE_RIGHT_IMAGE);
			...
			if(i == 4){
				...
				news.setTypeCode(ITEM_TYPE_SINGLE_IMAGE);
