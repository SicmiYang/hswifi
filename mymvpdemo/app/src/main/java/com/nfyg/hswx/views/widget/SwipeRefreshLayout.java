        ...
        public void onAnimationEnd(Animation animation) {
            ...
            if (mRefreshing) {
                if (mNotify) {
                    ...
                    if (mListener != null) {
                        mListener.onRefresh(isBackHome);
                        if (isBackHome){
                            isBackHome = false;
                            defaultProgressView.setVisibility(VISIBLE);
                            homeimageView.setVisibility(GONE);
                        }
                    }
                }
            } else {
...
//            mListener.onPullDistance(distance);
            ...
            if (distance >= BACK_HOME_DISTANCE) {
    ...
    public void setUsingDefaultHeader(){
        mHeadViewContainer.removeAllViews();
    ...
    private void createHeaderViewContainer() {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(
                (int) (mHeaderViewHeight * 0.4),
                (int) (mHeaderViewHeight * 0.4));
         homeimageView =  new ImageView(getContext());
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
               28, 28);
        lp.gravity = Gravity.CENTER;
        homeimageView.setImageResource(R.drawable.home);
        homeimageView.setLayoutParams(lp);
        ...
        mHeadViewContainer.addView(homeimageView, layoutParams);
    ...
    private void setAnimationProgress(float progress) {
        if (!usingDefaultHeader&&!isBackHome) {
            progress = 1;
        }
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mIsBeingDragged) {
                    ...
                    if (overscrollTop<BACK_HOME_DISTANCE){
                        isBackHome=false;
                        defaultProgressView.setVisibility(View.VISIBLE);
                        homeimageView.setVisibility(View.GONE);
                    }
...
//        }
    ...
    public class CircleProgressView extends View implements Runnable {
        ...
        private int progressColor = 0xff00A2ED;
